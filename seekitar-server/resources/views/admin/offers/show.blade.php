      ...
      <div class="card shadow-sm">
        <div class="card-body p-4">
          ...
          <div class="table-responsive mb-4">
            <table class="table table-bordered align-middle mb-0 fs-3">
              <tbody>
                <tr>
                ...
                <tr>
                  ...
                  <td class="text-dark">{{ $offer->expires_at?->format('d M Y H:i') }}</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      @if ($offer->store)
        <div class="card shadow-sm mt-4">
          <div class="card-body p-4">
            ...
            <a href="{{ route('admin.stores.show', $offer->store_id) }}" class="btn btn-sm btn-outline-primary w-100"><i class="ti ti-store me-1"></i> Detail Toko Penjual</a>
          </div>
        </div>
      @endif
    </div>
      ...
      @if ($offer->request)
        ...
        <div class="card shadow-sm mb-4">
          <div class="card-body p-4">
            ...
            <a href="{{ route('admin.requests.show', $offer->request_id) }}" class="btn btn-sm btn-outline-primary w-100"><i class="ti ti-rectangle me-1"></i> Detail Permintaan</a>
          </div>
        </div>
        ...
        @if ($offer->request->user)
          <div class="card shadow-sm mb-4">
            <div class="card-body p-4">
              ...
              <a href="{{ route('admin.users.show', $offer->request->user_id) }}" class="btn btn-sm btn-outline-primary w-100"><i class="ti ti-user me-1"></i> Detail Akun Pembeli</a>
            </div>
          </div>
        @endif
      @endif
