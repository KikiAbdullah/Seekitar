      ...
      <div class="card shadow-sm mb-4">
        <div class="card-body p-4">
          ...
          <div class="d-flex align-items-center gap-3 mb-3">
            <img src="{{ $listing->store ? (\App\Support\PlaceholderImg::src($listing->store->getRawOriginal('photo')) ?? 'https://placehold.co/100x100?text=Toko') : 'https://placehold.co/100x100?text=Toko' }}" class="rounded-circle border" width="48" height="48" style="object-fit: cover;">
            <div>
