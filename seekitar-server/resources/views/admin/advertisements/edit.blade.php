...
@section('content')
    ...
    <div class="card bg-light-primary shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-12">
                    <h4 class="fw-semibold mb-2">Sunting Iklan</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.advertisements.update', $ad) }}">
                @csrf @method('PUT')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                               value="{{ old('title', $ad->title) }}" required maxlength="200">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                  rows="3" maxlength="2000">{{ old('description', $ad->description) }}</textarea>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="url" name="image_url" class="form-control @error('image_url') is-invalid @enderror"
                               value="{{ old('image_url', $ad->image_url) }}" maxlength="500">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="url" name="link_url" class="form-control @error('link_url') is-invalid @enderror"
                               value="{{ old('link_url', $ad->link_url) }}" maxlength="500">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <select name="position" class="form-select js-select2 @error('position') is-invalid @enderror"
                                data-min-search="20">
                            <option value="feed" @selected(old('position', $ad->position) === 'feed')>Feed Beranda</option>
                            <option value="sidebar" @selected(old('position', $ad->position) === 'sidebar')>Sidebar</option>
                            <option value="search" @selected(old('position', $ad->position) === 'search')>Hasil Pencarian</option>
                            <option value="category" @selected(old('position', $ad->position) === 'category')>Halaman Kategori</option>
                        </select>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="price_per_day" class="form-control @error('price_per_day') is-invalid @enderror"
                               value="{{ old('price_per_day', $ad->price_per_day) }}" min="0" step="1000">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <select name="status" class="form-select js-select2 @error('status') is-invalid @enderror"
                                data-min-search="20">
                            <option value="available" @selected(old('status', $ad->status) === 'available')>Tersedia</option>
                            <option value="active" @selected(old('status', $ad->status) === 'active')>Aktif</option>
                            <option value="inactive" @selected(old('status', $ad->status) === 'inactive')>Nonaktif</option>
                        </select>
