...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _pages = [
    _OnboardPage(title: 'Pasar di Sekitarmu', desc: 'Temukan barang, jasa, dan sewa dari tetangga terdekat. Fokus satu kabupaten, bukan seluruh Indonesia.', icon: Icons.store, color: Color(0xFF168A4A)),
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(children: [
          Align(alignment: Alignment.topRight, child: TextButton(onPressed: () => ctx.go('/login'), child: const Text('Lewati', style: TextStyle(fontWeight: FontWeight.w600)))),
          ...
          Padding(padding: const EdgeInsets.all(24), child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...List.generate(_pages.length, (i) => Container(margin: const EdgeInsets.symmetric(horizontal: 4), width: _page == i ? 24 : 8, height: 8, decoration: BoxDecoration(color: _page == i ? t.colorScheme.primary : Colors.grey.shade300, borderRadius: BorderRadius.circular(4)))),
          ])),
