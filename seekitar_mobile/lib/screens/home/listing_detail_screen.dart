...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
  ...
  void _buy() {
    final l = _detail;
    if (l == null) return;
    // Hanya pengguna terverifikasi yang boleh membeli — yang belum verifikasi
    // hanya bisa melihat-lihat listing.
    final u = context.read<AppState>().user;
    if (u == null || !u.isVerified) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: const Text('Verifikasi KTP dulu untuk membeli.'),
