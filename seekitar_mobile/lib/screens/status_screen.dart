...
class _StatusScreenState extends State<StatusScreen> {
  ...
  @override Widget build(BuildContext ctx) => Scaffold(
    ...
    body: _loading ? const Center(child: CircularProgressIndicator()) : RefreshIndicator(onRefresh: _load, child: ListView(padding: const EdgeInsets.all(16), children: [
      ...
      _component(Icons.notifications, 'Notifikasi (WA)', 'WhatsApp gateway', _config?['whatsapp']?.toString().isNotEmpty == true ? 'sehat' : 'belum dikonfigurasi'),
      ...
      Card(child: Padding(padding: const EdgeInsets.all(16), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        _row('WhatsApp', '+62 ${_config?['whatsapp']?.toString() ?? '-'}'),
